...
void SerialClass::callback(const hand_control::hand_control_cmd::ConstPtr msg)
{
...
unsigned char SerialClass::sendCmd(const hand_control::hand_control_cmd::ConstPtr msg)
{
